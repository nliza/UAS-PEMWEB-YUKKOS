...
<body>
    <div class="container-xxl bg-white p-0">
                ...
                <div class="row g-0 gx-5 align-items-end">
                    <div class="col-lg-6">
                        <div class="text-start mx-auto mb-5 wow slideInLeft" data-wow-delay="0.1s">
                            <h1 class="mb-3">Hasil Semua Pencarian!</h1>
                        </div>
                    </div>
                </div>
                <div class="tab-content">
                    <div id="tab-1" class="tab-pane fade show p-0 active">
                        <div class="row g-4">
                            ...
                            <?php
                            include ("koneksi.php");
                            $sql="SELECT * FROM tb_kos WHERE KategoriKos = 'Laki-laki'";
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        <a href=""><img class="img-fluid" src="img/kos.jpeg" alt=""></a>
                                        <div
                                    ...
                                    <div class="p-4 pb-0">
                                        <h5 class="text-primary mb-3"><?= "Rp".number_format($row["HargaKos"], 0, ",", ".").",-"; ?></h5>
                                        <a class="d-block h5 mb-2" href="about.php?id=<?php echo $row['id_kos']?>"><?= $row["NamaKos"]; //echo $row["NamaKos"] ?></a>
                                        <p><i class="fa fa-map-marker-alt text-primary me-2"></i><?= $row["Alamat"]; //echo $row["Alamat"] ?></p>
                                    </div>
        ...
        <div class="col-12 text-center">
            <a class="btn btn-primary py-3 px-5" href="beranda.php"><<< Kembali ke menu Home >>></a>
        </div>
        <!-- Property List End -->
