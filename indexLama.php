...
session_start();
//Koneksi ke database
$koneksi = new mysqli("localhost", "root", "", "yukos");
?>
        ...
        <div class="container-fluid nav-bar bg-transparent">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                <a href="index.html" class="navbar-brand d-flex align-items-center text-center">
                    ...
                    <h1 class="m-0 text-primary">Yukos!</h1>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0 dropdown-menu-end">
                                <a href="perempuan.php" class="dropdown-item">Perempuan</a>
                                <a href="laki-laki.html" class="dropdown-item">Laki-laki</a>
                                <a href="campuran.html" class="dropdown-item">Campuran</a>
                            </div>
                        </div>
                        <a href="testimonial.html" class="nav-item nav-link active">Testimoni</a>
                    ...
                    <div class="dropdown-menu rounded-0 m-0 dropdown-menu-end">
                        ...
                        <a href="property-agent.html" class="dropdown-item">Pemilik</a>
        ...
        <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
            <div class="col-md-6 p-5 mt-lg-5">
                <h1 class="display-5 animated fadeIn mb-4">Cari <span class="text-primary">Berbagai Kos</span>
                    Disini!!!</h1>
                <p class="animated fadeIn mb-4 pb-2">Khusus Kos dekat UPN "Veteran" Jawa Timur</p>
            ...
            <div class="row g-2">
                <div class="col-md-10">
                    <div class="row g-2">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control border-0 py-3" placeholder="Pilih Lokasi">
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="property-item rounded overflow-hidden">
                                    ...
                                    <div class="p-4 pb-0">
                                        <h5 class="text-primary mb-3">Rp1.200.000</h5>
                                        <a class="d-block h5 mb-2" href="">Kos Wongmadyo</a>
                                        <p><i class="fa fa-map-marker-alt text-primary me-2"></i>Medokan Asri</p>
                                    </div>
                                    <div class="d-flex border-top">
                                        <!-- <small class="flex-fill text-center border-end py-2"><i class="fa fa-ruler-combined text-primary me-2"></i>1000 Sqft</small> -->
                                        <small class="flex-fill text-center border-end py-2"><i
                                                class="fa fa-bed text-primary me-2"></i>1 Orang</small>
                                        <small class="flex-fill text-center py-2"><i
                                                class="fa fa-bath text-primary me-2"></i>KM. Dalam</small>
                                    </div>
                                </div>
                            </div>
                            <?php 
                            ...
                            <!-- <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="property-item rounded overflow-hidden">
                                    ...
                                    <div class="p-4 pb-0">
                                        ...
                                        <p><i class="fa fa-map-marker-alt text-primary me-2"></i>123 Street, New
                                            York, USA</p>
                                    </div>
                                    <div class="d-flex border-top">
                                        <small class="flex-fill text-center border-end py-2"><i
                            ...
                            <div class="col-12 text-center wow fadeInUp" data-wow-delay="0.1s">
                                <a class="btn btn-primary py-3 px-5" href="">Lihat Kos Lainnya Disini >>></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-light rounded p-3">
                    <div class="bg-white rounded p-4" style="border: 1px dashed rgba(0, 185, 142, .3)">
                        <div class="row g-5 align-items-center">
                            ...
                            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                                <div class="mb-4">
                                    <h1 class="mb-3">Contact With Yukos! Customer Service</h1>
