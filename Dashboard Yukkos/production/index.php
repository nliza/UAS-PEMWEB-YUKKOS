...
$query = mysqli_query($koneksi, "SELECT KategoriKos, SUM(totalHarga) AS totalPembelian FROM tb_transaksi GROUP BY KategoriKos");

$labels = [];
$totalPembelian = [];

while ($row = mysqli_fetch_assoc($query)) {
    $KategoriKos = $row['KategoriKos'];
    $totalHarga = $row['totalPembelian'];
      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.php" class="site_title"><i class="fa fa-user"></i> <span>Yukkos!</span></a>
          </div>
          ...
          <div class="col-md-7 col-sm-7 ">
            <div class="dashboard_graph">
              ...
              <script>
                ...
                var totalPembelian = <?php echo json_encode($totalPembelian); ?>;
